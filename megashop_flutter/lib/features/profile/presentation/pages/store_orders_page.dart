    ...
    if (user == null) {
      return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text('Store Orders', style: AppTextStyles.productName.copyWith(fontSize: 18)),
          centerTitle: true,
        ),
        body: const Center(child: Text('Please login to view store orders.')),
      );
    }
        ...
        builder: (context, snapshot) {
          ...
          if (docs.isEmpty) {
            return Center(
              child: Column(
                ...
                children: [
                  const Icon(CupertinoIcons.cube_box, size: 64, color: AppColors.iconMuted),
                  const SizedBox(height: 16),
                  Text('No orders yet', style: AppTextStyles.sectionTitle),
                  const SizedBox(height: 8),
                  Text('You have not received any orders.', style: AppTextStyles.brandName),
                ],
              ),
            );
          }
          ...
          return ListView.separated(
            ...
            itemBuilder: (context, index) {
              ...
              final buyerEmail = data['buyerEmail'] ?? 'Buyer';
              ...
              return MouseRegion(
                ...
                child: GestureDetector(
                  onTap: () {
                    Navigator.pushNamed(context, '/store-order-detail', arguments: orderId);
                  },
                  child: Container(
